...
module.exports.routes = {
  ...
  // CRUD para Perfis
  'GET /perfil/listar': { action: 'Perfil/Perfil/listar' },
  'GET /perfil/:id': { action: 'Perfil/Perfil/buscar' },
  'POST /perfil/': { action: 'Perfil/Perfil/criar' },
  'PUT /perfil/:id': { action: 'Perfil/Perfil/atualizar' },
  'DELETE /perfil/:id': { action: 'Perfil/Perfil/deletar' },


  // CRUD para permissão
  'GET /permissoes/listar': { action: 'Permissao/Permissao/listar' },
  'GET /permissoes/:id': { action: 'Permissao/Permissao/buscar' },
  'POST /permissoes': { action: 'Permissao/Permissao/criar' },
  'PUT /permissoes/:id': { action: 'Permissao/Permissao/atualizar' },
  'DELETE /permissoes/:id': { action: 'Permissao/Permissao/deletar' },
